...
const CATEGORIES = [
  // Backend/Cloud/AI lead, Frontend after — positioning for backend /
  // distributed-systems roles, not a frontend-first identity.
  ...
  { title: 'Cloud / AWS',       tags: ['Lambda','API Gateway','Step Functions','AWS SAM','AWS CodePipeline','S3','SNS','SQS','CloudWatch','IAM','Textract','Cognito','Secrets Manager','EventBridge','SSM Parameter Store'] },
  { title: 'AI / GenAI',        tags: ['AWS Bedrock','Bedrock Agent Core','Strands Agents SDK','MCP (client & server)','Claude Sonnet 4.6','Claude Haiku','Prompt Engineering','LLM Evaluation / LLM-as-Judge','RAG / pgvector / Titan embeddings','Tool Use / Function Calling','Anti-hallucination Guardrails','AI Agent Orchestration','Amazon Transcribe','Web Speech API','OpenAPI Schema Design','GitHub Copilot'] },
  { title: 'Frontend',          tags: ['React','JavaScript','TypeScript','HTML5','CSS3/SCSS','Bootstrap','React Hooks','Context API','Vite','Framer Motion'] },
  { title: 'Databases',         tags: ['PostgreSQL/Aurora','pgvector','MongoDB/DocumentDB','MySQL','DynamoDB'] },
