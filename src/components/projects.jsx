...
const PROJECTS = [
  {
    ...
    desc: 'Full-stack Arsenal F.C. hub — live scores, AI match predictions (AWS Bedrock), news feed, Champions League tracking, and squad info.',
    tags: ['React 18', 'Vite', 'AWS Lambda', 'AWS Bedrock', 'Serverless', 'Firebase', 'SCSS'],
